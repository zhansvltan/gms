...
export default function ImageComponent() {
  return (
    <>
      ...
      />
      <div style={{left:'55px', top:'170px'}} className="absolute flex-col justify-between space-y-10">
        <h2
          style={{
            maxWidth: "646px",
            width: "100%",
          }}
          className="text-white text-[52px] font-[900]"
        >
        ...
        <button
          className="leading-tight text-[16px] text-[#000000] bg-[#c3f2cb] rounded-3xl font-[600] w-[316px] h-[45px]"
        >
          Узнать подробнее
        </button>
      </div>
