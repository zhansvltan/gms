...
export default function GroupsComponent() {
  return (
    <div className="bg-white" id="groups">
      <h2
        className="font-[500] text-[#5d5d5b] mb-8 mt-8
      ...
      <div
        className="flex 
      mobile:flex-col mobile:space-y-3 mobile:items-center mobile:text-justify 
      laptop:flex-row laptop:space-y-0 laptop:items-stretch laptop:justify-between laptop:px-16 laptop:text-start"
      >
        <div
        ...
        >
          <h3 className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[500] mobile:leading-[24px] laptop:leading-[31px] m-0">
            IEC International
          </h3>
          <p className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[300] mobile:leading-[24px] laptop:leading-[31px] m-0 mb-8 ">
            Париж, Франция
          </p>
          <p className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[300] mobile:leading-[24px] laptop:leading-[31px] m-0 laptop:w-[90%]">
        ...
        >
          <h3 className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[500] mobile:leading-[24px] laptop:leading-[31px]">
            IEC Application & Services
          </h3>
          <p className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[300] mobile:leading-[24px] laptop:leading-[31px] mb-8 ">
            Париж, Франция
          </p>
          <p className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[300] mobile:leading-[24px] laptop:leading-[31px] w-[90%]">
