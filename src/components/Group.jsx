  ...
  return (
    <div className="bg-white" id="groups">
      ...
      >
        ...
        >
          <h3 className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[300] mobile:leading-[24px] laptop:leading-[31px] m-0">
            IEC International
          </h3>
        ...
        >
          <h3 className="text-[#ffffff] mobile:text-[14px] tablet:text-[16px] laptop:text-[24px] font-[300] mobile:leading-[24px] laptop:leading-[31px]">
